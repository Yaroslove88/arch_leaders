...
RUN pnpm --filter @leadership-architect/ui build || true
...
ARG NEXT_PUBLIC_TELEGRAM_BOT_USERNAME=arhitecture_leaders_bot
...
# Install OpenSSL for Prisma/PayloadCMS runtime
...
# PayloadCMS requires these at runtime (set via Timeweb env vars)
# DATABASE_URL - PostgreSQL connection string
# PAYLOAD_SECRET - JWT secret for PayloadCMS auth
