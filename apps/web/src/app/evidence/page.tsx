      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-bg-panel border border-system-focus/30 rounded-lg p-6 mb-8 shadow-panel">
          ...
          <ul className="space-y-2 text-ui-text-muted mb-4">
            ...
            <li>
              <strong className="text-ui-text-main">Доказательства</strong> — это конкретные примеры применения способности: "В этой ситуации я удержал напряжение 10 минут", 
              "Я дал обратную связь по структуре факт-влияние-предложение", "Я нарисовал карту системы с 8 элементами". 
