...
export function Toast({ message, type = 'info', duration = 5000, onClose }: ToastProps) {
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 rounded-lg shadow-lg border ${typeStyles[type]} animate-in slide-in-from-top-5 fade-in`}
      role="alert"
      aria-live="polite"
    >
      ...
      <button
        onClick={onClose}
        className="ml-2 text-ui-text-dim hover:text-ui-text-muted focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-system-focus rounded"
